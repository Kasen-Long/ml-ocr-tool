                    ...
                    <tbody>
                      ${result
                          ...
                          <tr data-index='${index}'>
                            ...
                            <td contenteditable="true" data-index='${index}' class="${bgColor}">${item.name
                                    }</td>
                            <td contenteditable="true" data-index='${index}' class="${bgColor}">${item.pageNumber
                                    }</td>
                            <td contenteditable="true" data-index='${index}' class="${bgColor}">${item.page
                                    }</td>
                ...
                function bindEvents() {
                    ...
                    table.querySelectorAll("[contenteditable]").forEach((cell) => {
                        cell.oninput = () => {
                            ...
                            result[rowIndex][field] = cell.textContent;
